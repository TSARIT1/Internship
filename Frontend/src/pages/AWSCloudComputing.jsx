...
const AWSCloudComputing = () => {
    ...
    const { totalFee, discount, finalFee, loading } = useCoursePricing("AWS Cloud Computing");
                ...
                <div className="relative bg-slate-900 text-white pt-32 pb-24 overflow-hidden">
                    ...
                    <div className="container mx-auto px-6 relative z-10 text-center max-w-4xl">
                        ...
                        <div className="flex flex-wrap justify-center gap-6">
                            <EnrollButton course="AWS Cloud Computing" className="bg-teal-500 hover:bg-teal-600 text-white px-8 py-4 rounded-full font-bold text-lg transition-all hover:scale-105 shadow-lg shadow-teal-500/30 flex items-center gap-2">
                        ...
                        <div className="lg:col-span-1">
                            <div className="sticky top-24">
                                <div className="bg-white rounded-3xl shadow-xl border border-slate-100 p-8 text-center relative overflow-hidden mb-8">
                                    ...
                                    <EnrollButton course="AWS Cloud Computing" className="w-full bg-teal-500 hover:bg-teal-600 text-white font-bold py-4 rounded-xl shadow-lg shadow-teal-500/20 transition-all transform hover:-translate-y-1 mb-4 flex items-center justify-center gap-2">
