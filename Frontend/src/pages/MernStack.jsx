...
import {
    ...
    Zap, ArrowLeft, ArrowRight, Globe, Layers, Cpu
} from 'lucide-react';
...
const MernStack = () => {
    const data = {
        ...
        description: "Become a Full Stack Developer. Master MongoDB, Express, React, and Node.js.",
        duration: "5 Months",
        level: "Intermediate",
        ...
        features: [
            { icon: Layout, title: "Modern UI/UX", desc: "Build responsive interfaces" },
            { icon: Server, title: "Scalable Backend", desc: "Design robust APIs" },
            { icon: Database, title: "Data Management", desc: "Master NoSQL databases" },
            { icon: Users, title: "Agile Practice", desc: "Work in agile sprints" },
            { icon: Globe, title: "Real Deployment", desc: "Deploy live applications" },
            { icon: BookOpen, title: "Code Reviews", desc: "Standard code practices" }
        ],
        projects: [
            {
                title: "E-Commerce Platform",
                desc: "Full-stack shopping cart with payment gateway",
                tags: ["Redux", "Stripe", "MongoDB"],
                image: "https://images.unsplash.com/photo-1557821552-17105176677c?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80"
            },
            {
                title: "Social Media App",
                desc: "Real-time chat and post sharing application",
                tags: ["Socket.io", "React", "Node.js"],
                image: "https://images.unsplash.com/photo-1611162617474-5b21e879e113?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80"
            },
            {
                title: "Task Management Tool",
                desc: "Project management dashboard like Trello",
                tags: ["Drag & Drop", "Express", "JWT"],
        ...
        outcomes: [
            ...
            "Master the entire Javascript ecosystem",
    ...
    const tools = [
        ...
        { name: "Express", icon: "https://upload.wikimedia.org/wikipedia/commons/6/64/Expressjs.png" }, // Using png for Express as SVG often has issues visibility
    ...
    const { totalFee, discount, finalFee, loading } = useCoursePricing("MERN Stack");
        ...
        <div className="min-h-screen bg-slate-50 font-sans selection:bg-orange-100">
            ...
            <div className="relative bg-slate-900 text-white pt-32 pb-24 overflow-hidden">
                ...
                <div className="container mx-auto px-6 relative z-10 text-center max-w-4xl">
                    <div className="inline-flex items-center gap-2 bg-orange-500/10 text-orange-300 px-4 py-1.5 rounded-full text-sm font-bold uppercase tracking-widest border border-orange-500/20 mb-8 backdrop-blur-sm">
                    ...
                    <div className="flex flex-wrap justify-center gap-6">
                        <EnrollButton course="MERN Stack" className="bg-orange-600 hover:bg-orange-700 text-white px-8 py-4 rounded-full font-bold text-lg transition-all hover:scale-105 shadow-lg shadow-orange-600/30 flex items-center gap-2">
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-16">
                        <div className="lg:w-1/2">
                            ...
                            <p className="text-slate-600 text-lg mb-8 leading-relaxed">
                                From crafting pixel-perfect frontends to architecting scalable backends, become a complete software engineer.
                            </p>
                            <ul className="space-y-4">
                                {[
                                    "Build Interactive UIs with React & Redux",
                                    "Create RESTful APIs with Node.js & Express",
                                    "Manage Data with MongoDB (NoSQL)",
            ...
            <section className="py-20 bg-slate-50">
                <div className="container mx-auto px-6">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-slate-600 max-w-2xl mx-auto">The ultimate toolkit for aspiring full-stack developers.</p>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {data.features.map((feature, idx) => (
                            <div key={idx} className="bg-white p-8 rounded-2xl shadow-sm border border-slate-100 hover:shadow-xl transition-all text-center group">
                                <div className="w-16 h-16 bg-orange-50 text-orange-600 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:bg-orange-600 group-hover:text-white transition-colors duration-300">
                    ...
                    <div className="lg:col-span-2 space-y-16">
                        ...
                        <section>
                            <h2 className="text-3xl font-bold text-slate-900 mb-8 flex items-center gap-3">
                                <BookOpen className="text-orange-600" /> Comprehensive Curriculum
                            </h2>
                                    ...
                                    <div key={idx} className="bg-white rounded-2xl border border-slate-200 overflow-hidden">
                                        ...
                                        >
                                            <div className="flex items-center gap-4">
                                                <div className={`w-8 h-8 rounded-full flex items-center justify-center font-bold text-sm border ${openSection === idx ? 'bg-orange-600 text-white border-orange-600' : 'bg-white text-slate-500 border-slate-300'}`}>
                                                    {idx + 1}
                                                </div>
                                                <span className={`font-bold text-lg ${openSection === idx ? 'text-orange-700' : 'text-slate-800'}`}>{section.title}</span>
                                            </div>
                                            {openSection === idx ? <ChevronUp size={20} className="text-orange-600" /> : <ChevronDown size={20} className="text-slate-400" />}
                                        </button>
                                        {openSection === idx && (
                    ...
                    <div className="lg:col-span-1">
                        <div className="sticky top-24">
                            <div className="bg-white rounded-3xl shadow-xl border border-slate-100 p-8 text-center relative overflow-hidden mb-8">
                                ...
                                <EnrollButton course="MERN Stack" className="w-full bg-orange-600 hover:bg-orange-700 text-white font-bold py-4 rounded-xl shadow-lg shadow-orange-500/20 transition-all transform hover:-translate-y-1 mb-4 flex items-center justify-center gap-2">
                            ...
                            <div className="bg-slate-900 rounded-3xl p-8 text-white relative overflow-hidden">
                                <div className="relative z-10">
                                    ...
                                    <a href="mailto:nnikhiln2002@gmail.com?subject=Inquiry%20about%20MERN%20Stack%20Internship&body=Hello%20Team%2C%0A%0AI%20am%20interested%20in%20the%20MERN%20Stack%20Internship%20Program.%20Please%20provide%20more%20details%20regarding%20the%20enrollment%20process.%0A%0AThanks" className="block w-full text-center bg-white text-slate-900 font-bold py-3 rounded-xl hover:bg-orange-50 transition-colors text-sm">
                                        Book Free Session
                                    </a>
                                </div>
                                <div className="absolute bottom-[-20%] right-[-20%] w-32 h-32 bg-orange-500 rounded-full blur-3xl opacity-20"></div>
                            </div>
                        </div>
                    </div>
                </div>
